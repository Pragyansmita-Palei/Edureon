...
export default function InstituteDetailPage() {
  ...
  const impersonate = () => {
    ...
    toast.success(`Impersonating Admin of ${inst.name}`, {
      description:
      ...
      <Tabs defaultValue="overview">
        ...
        >
          <Card className="border-border/60 lg:col-span-1">
            ...
            <CardContent className="space-y-2 text-sm">
              <Row
                ...
                v={
                  [inst.address, inst.city, inst.state, inst.pin]
                    .filter(Boolean)
                    .join(", ") || "—"
                }
              />
          ...
          <Card className="border-border/60 lg:col-span-2">
            ...
            <CardContent className="grid sm:grid-cols-2 gap-4">
              <PersonCard
                role="Principal"
                name={inst.principalName}
                phone={inst.principalPhone}
              />
              <PersonCard
                role="Admin Contact"
                name={inst.adminName}
                phone={inst.adminPhone}
              />
            </CardContent>
          </Card>
          <Card className="border-border/60 lg:col-span-3">
            <CardHeader>
              ...
              <CardDescription>Last 8 months — fees collected</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="profile" className="mt-4 grid md:grid-cols-2 gap-4">
          <Card className="border-border/60">
            <CardHeader>
              <CardTitle className="text-base">Basic & Registration</CardTitle>
            </CardHeader>
          ...
          <Card className="border-border/60">
            <CardHeader>
              <CardTitle className="text-base">Legal & Financial</CardTitle>
            </CardHeader>
            <CardContent className="text-sm space-y-2">
          ...
          <Card className="border-border/60">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Users with access to this institute
                </CardDescription>
              </div>
              <Button size="sm" className="gradient-primary border-0" asChild>
                <Link to="/super/users">Create user</Link>
              </Button>
            </CardHeader>
        ...
        >
          <div className="lg:col-span-2 p-3 rounded-md border border-dashed text-xs text-muted-foreground flex items-center gap-2">
            ...
            as an Admin would. All actions are read-only in Super Admin view.
          </div>
          <Card className="border-border/60">
            <CardHeader>
              <CardTitle className="text-base">
...
function PersonCard({ role, name, phone }) {
  return (
