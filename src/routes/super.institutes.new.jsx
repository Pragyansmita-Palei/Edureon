...
export default function NewInstitutePage() {
  ...
  const [docs, setDocs] = useState(
    Object.fromEntries(DOC_SLOTS.map((d) => [d, "pending"])),
  );
          ...
          <CardContent className="space-y-1 p-2">
            {STEPS.map((s) => (
              <button
                ...
                className={`w-full text-left flex items-start gap-2.5 p-2.5 rounded-md transition-colors ${step === s.id ? "bg-primary/10" : s.id < step ? "hover:bg-muted/50" : "hover:bg-muted/30"}`}
              >
                <div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Field label="Board Affiliation">
                  ...
                  >
                    ...
                    <SelectContent>
                      {["CBSE", "ICSE", "IB", "State Board", "Cambridge"].map(
                        (b) => (
            ...
            {step === 6 && (
              <div className="space-y-4">
                ...
                <Review
                  title="Documents"
                  items={[
                    ["Uploaded", `${uploadedCount} / ${DOC_SLOTS.length}`],
                  ]}
                  onEdit={() => setStep(5)}
                />
              </div>
