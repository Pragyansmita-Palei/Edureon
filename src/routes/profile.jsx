  ...
  return (
    <PageContainer>
      <PageHeader
        eyebrow="Account"
        title="My Profile"
        description="Manage how you appear across Scholaris and update your personal information."
      />
        ...
        <div className="lg:col-span-2 space-y-5">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                This information appears on your school profile and
                notifications.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Your last actions in the workspace.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              {[
                ...
                {
                  t: "Published Term 2 examination schedule",
                  time: "Yesterday",
                },
                ...
                <div
                  key={i}
                  className="flex items-center justify-between p-2.5 rounded-md hover:bg-muted/50"
                >
